...
public class TestBookController {
    ...
    /*
     *  Tests that the controller dispatches a view containing at least 3 books (the number of categories generated by DbUtil minus one -- in case delete test has run).
     *  Tests that one of the  books is indeed the fiction category object.
     *  Tests our list size is 3 or greater (greater because add or delete  test might run first).  
     *   We should have between 3 and 5 categories for the duration of this suite.
     *
    ...
    public void testListView() {
        ...
        try {
            ...
            assertTrue("list must have size of 3 or more ", (list.size() >= 3));
